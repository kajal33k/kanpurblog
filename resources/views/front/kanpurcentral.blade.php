...
@section('content')
    ...
    <div class="container mx-auto p-6 flex flex-col md:flex-row gap-8">
        ...
        <aside class="md:w-1/4 bg-white shadow-lg rounded-lg p-6 space-y-6">
            ...
            <!-- Popular Places -->
            <div>
                <h3 class="text-xl font-semibold mb-2">Popular Places</h3>
                <ul class="list-disc pl-5 space-y-2 text-gray-700">
                    <li><a href="#famous-places" class="text-red-600 hover:underline">Kanpur Central Facts</a></li>
                    <li><a href="#weather" class="text-red-600 hover:underline">Kanpur Weather</a></li>
                    <li><a href="#contact" class="text-red-600 hover:underline">Contact Us</a></li>
                </ul>
            </div>
