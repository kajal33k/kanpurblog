...
<div class="container mx-auto p-6 flex flex-col lg:flex-row gap-8">
    ...
    <div class="lg:w-3/4 space-y-6">
        <!-- Restaurant 1 -->
        <div id="yellow-chilli" class="bg-white shadow-lg rounded-lg p-6" data-aos="fade-up">
            <h2 class="text-2xl font-semibold text-red-600 p-4 text-center" data-aos="fade-up">The Yellow Chilli</h2>
        ...
        <!-- Restaurant 2 -->
        <div id="biryani-blues" class="bg-white shadow-lg rounded-lg p-6" data-aos="fade-up">
            <h2 class="text-2xl font-semibold text-red-600 p-4 text-center" data-aos="fade-up">Biryani Blues</h2>
            <div class="flex flex-col lg:flex-row gap-4" data-aos="fade-up">
                <div class="lg:w-1/2" data-aos="fade-up">
        ...
        <!-- Restaurant 3 -->
        <div id="cafe-7" class="bg-white shadow-lg rounded-lg p-6" data-aos="fade-up">
            <h2 class="text-2xl font-semibold text-red-600 p-4 text-center" data-aos="fade-up">Cafe 7</h2>
            <div class="flex flex-col lg:flex-row gap-4" data-aos="fade-up">
                <div class="lg:w-1/2" data-aos="fade-up">
        ...
        <!-- Restaurant 4 -->
        <div id="rajasthan-bhojnalaya" class="bg-white shadow-lg rounded-lg p-6" data-aos="fade-up">
            <h2 class="text-2xl font-semibold text-red-600 p-4 text-center" data-aos="fade-up">Rajasthan Bhojnalaya</h2>
            <div class="flex flex-col lg:flex-row gap-4" data-aos="fade-up">
                <div class="lg:w-1/2" data-aos="fade-up">
        ...
        <!-- Restaurant 5 -->
        <div id="moti-mahal-delux" class="bg-white shadow-lg rounded-lg p-6" data-aos="fade-up">
            <h2 class="text-2xl font-semibold text-red-600 p-4 text-center" data-aos="fade-up">Moti Mahal Delux</h2>
            <div class="flex flex-col lg:flex-row gap-4" data-aos="fade-up">
                <div class="lg:w-1/2" data-aos="fade-up">
        ...
        <!-- Restaurant 6 -->
        <div id="gola-sizzlers" class="bg-white shadow-lg rounded-lg p-6" data-aos="fade-up">
            <h2 class="text-2xl font-semibold text-red-600 p-4 text-center" data-aos="fade-up">Gola Sizzlers</h2>
            <div class="flex flex-col lg:flex-row gap-4" data-aos="fade-up">
                <div class="lg:w-1/2" data-aos="fade-up">
        ...
        <!-- Restaurant 7 -->
        <div id="tandoor-hut" class="bg-white shadow-lg rounded-lg p-6" data-aos="fade-up">
            <h2 class="text-2xl font-semibold text-red-600 p-4 text-center" data-aos="fade-up">Tandoor Hut</h2>
            <div class="flex flex-col lg:flex-row gap-4" data-aos="fade-up">
                <div class="lg:w-1/2" data-aos="fade-up">
        ...
        <!-- Restaurant 8 -->
        <div id="lazeez-restaurant" class="bg-white shadow-lg rounded-lg p-6" data-aos="fade-up">
            <h2 class="text-2xl font-semibold text-red-600 p-4 text-center" data-aos="fade-up">Lazeez Restaurant</h2>
            <div class="flex flex-col lg:flex-row gap-4" data-aos="fade-up">
                <div class="lg:w-1/2" data-aos="fade-up">
        ...
        <!-- Restaurant 9 -->
        <div id="great-indian-kitchen" class="bg-white shadow-lg rounded-lg p-6" data-aos="fade-up">
            <h2 class="text-2xl font-semibold text-red-600 p-4 text-center" data-aos="fade-up">The Great Indian Kitchen</h2>
            <div class="flex flex-col lg:flex-row gap-4" data-aos="fade-up">
                <div class="lg:w-1/2" data-aos="fade-up">
        ...
        <!-- Restaurant 10 -->
        <div id="saffron-restaurant" class="bg-white shadow-lg rounded-lg p-6" data-aos="fade-up">
            <h2 class="text-2xl font-semibold text-red-600 p-4 text-center" data-aos="fade-up">Saffron Restaurant</h2>
            <div class="flex flex-col lg:flex-row gap-4" data-aos="fade-up">
                <div class="lg:w-1/2" data-aos="fade-up">
    ...
    <!-- Sidebar -->
    <aside class="lg:w-1/4 bg-white p-6 rounded-lg shadow-lg" data-aos="fade-up">
        <h2 class="text-2xl font-semibold mb-6" data-aos="fade-up">Quick Links</h2>
        <ul class="space-y-4" data-aos="fade-up">
            <li><a href="#yellow-chilli" class="text-lg text-red-800 hover:text-red-600 hover:underline" data-aos="fade-up">The Yellow Chilli</a></li>
            <li><a href="#biryani-blues" class="text-lg text-red-800 hover:text-red-600 hover:underline" data-aos="fade-up">Biryani Blues</a></li>
            <li><a href="#cafe-7" class="text-lg text-red-800 hover:text-red-600 hover:underline" data-aos="fade-up">Cafe 7</a></li>
            <li><a href="#rajasthan-bhojnalaya" class="text-lg text-red-800 hover:text-red-600 hover:underline" data-aos="fade-up">Rajasthan Bhojnalaya</a></li>
            <li><a href="#moti-mahal-delux" class="text-lg text-red-800 hover:text-red-600 hover:underline" data-aos="fade-up">Moti Mahal Delux</a></li>
            <li><a href="#gola-sizzlers" class="text-lg text-red-800 hover:text-red-600 hover:underline" data-aos="fade-up">Gola Sizzlers</a></li>
            <li><a href="#tandoor-hut" class="text-lg text-red-800 hover:text-red-600 hover:underline" data-aos="fade-up">Tandoor Hut</a></li>
            <li><a href="#lazeez-restaurant" class="text-lg text-red-800 hover:text-red-600 hover:underline" data-aos="fade-up">Lazeez Restaurant</a></li>
            <li><a href="#great-indian-kitchen" class="text-lg text-red-800 hover:text-red-600 hover:underline" data-aos="fade-up">The Great Indian Kitchen</a></li>
            <li><a href="#saffron-restaurant" class="text-lg text-red-800 hover:text-red-600 hover:underline" data-aos="fade-up">Saffron Restaurant</a></li>
        </ul>
    </aside>
</div>
@endsection
