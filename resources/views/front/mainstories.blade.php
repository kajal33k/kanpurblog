...
@section('content')
      <main class="flex flex-col lg:flex-row p-6 space-y-8 lg:space-y-0">
            <!-- Main Content -->
            <section class="flex-1 space-y-8">
                <article class="bg-white p-6 rounded-lg shadow-md" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <div class="prose max-w-none text-gray-700" data-aos="fade-left" data-aos-delay="300">
                ...
                <!-- Content Section -->
                <div class="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md mt-6" data-aos="fade-up" data-aos-delay="400">
                ...
                <!-- Contact Form -->
                <div class="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md mt-6" data-aos="fade-up" data-aos-delay="500">
                ...
                <section class="bg-white p-6 rounded-lg shadow-md" data-aos="fade-up" data-aos-delay="600">
                    <h3 class="text-xl font-bold mb-4 text-gray-800">You may also like</h3>
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        <!-- Related post items -->
                        <div class="bg-gray-100 rounded-lg shadow-md overflow-hidden" data-aos="fade-up" data-aos-delay="700">
                        ...
                        <div class="bg-gray-100 rounded-lg shadow-md overflow-hidden" data-aos="fade-up" data-aos-delay="800">
                        ...
                        <div class="bg-gray-100 rounded-lg shadow-md overflow-hidden" data-aos="fade-up" data-aos-delay="900">
                        ...
                        <div class="bg-gray-100 rounded-lg shadow-md overflow-hidden" data-aos="fade-up" data-aos-delay="1000">
            ...
            <!-- Sidebar -->
            <aside class="w-full md:w-1/4 md:ml-8 space-y-8 mt-8 md:mt-0" data-aos="fade-left" data-aos-delay="400">
