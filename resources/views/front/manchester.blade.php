...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6">
    ...
    <div class="md:col-span-3 space-y-8">
        ...
        <section class="bg-white shadow-lg rounded-lg p-6">
            <h2 class="text-3xl font-semibold text-red-600 mb-6">Historical Context</h2>
        ...
        <section class="bg-white shadow-lg rounded-lg p-6">
            <h2 class="text-3xl font-semibold text-red-600 mb-6">Economic Significance</h2>
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="flex justify-center lg:justify-start">
        ...
        <section class="bg-white shadow-lg rounded-lg p-6">
            <h2 class="text-3xl font-semibold text-red-600 mb-6 text-center">Modern-Day Kanpur</h2>
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="flex justify-center lg:justify-start">
    ...
    <aside class="md:col-span-1 space-y-8">
        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            <h3 class="text-2xl font-bold text-gray-800 mb-6 text-center">Weather Report</h3>
            <div class="flex items-center justify-center lg:justify-between mb-6 text-center lg:text-left">
                <img src="assets/img/weather.webp" alt="Weather Icon" class="w-16 h-16 object-center">
                <div>
                    <p class="text-gray-800 font-semibold text-2xl">28°C</p>
                    <p class="text-gray-600">Sunny</p>
                </div>
            </div>
            <p class="text-gray-700 text-center mb-4">Today's weather in Kanpur is sunny with a temperature of 28°C. Expect clear skies throughout the day.</p>
            <a href="https://forecast7.com/en/26d4580d33/kanpur/" class="text-blue-600 hover:underline text-center block">View Forecast</a>
        </div>
