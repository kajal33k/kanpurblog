...
@section('content')
<!-- Hero Section -->
<section class="relative py-20" data-aos="fade">
    <div class="absolute inset-0">
        <img src="assets/img/tinywow_app_62222055.png" alt="App Development" class="object-cover w-full h-full" data-aos="fade-in">
    </div>
    <div class="absolute inset-0 bg-black opacity-70"></div>
    <div class="relative z-10 container mx-auto px-4 text-center text-white">
        <h2 class="text-4xl md:text-5xl font-bold mb-6" data-aos="fade-up">App Development Solutions</h2>
        <p class="text-lg md:text-xl mb-8" data-aos="fade-up" data-aos-delay="100">Transforming ideas into powerful, user-friendly mobile applications</p>
        <a href="#" class="bg-white text-red-700 py-3 px-8 rounded-full font-semibold hover:bg-red-100 transition duration-300" data-aos="fade-up" data-aos-delay="200">Get Started</a>
    </div>
</section>
...
<main class="container mx-auto px-4 py-12">
    ...
    <!-- Services Grid -->
    <section class="mb-16">
        <h3 class="text-3xl font-semibold mb-8 text-red-600" data-aos="fade-up">Our App Development Services</h3>
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300" data-aos="fade-up" data-aos-delay="500">
    ...
    <section class="mb-16" data-aos="fade-up">
        ...
        <div class="flex flex-wrap justify-center">
            <div class="w-full md:w-1/2 lg:w-1/4 p-4 text-center" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="w-full md:w-1/2 lg:w-1/4 p-4 text-center" data-aos="fade-up" data-aos-delay="200">
                <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="w-full md:w-1/2 lg:w-1/4 p-4 text-center" data-aos="fade-up" data-aos-delay="300">
                <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="w-full md:w-1/2 lg:w-1/4 p-4 text-center" data-aos="fade-up" data-aos-delay="400">
                <div class="bg-white p-6 rounded-lg shadow-md">
...
<!-- Call to Action -->
<section class="bg-red-600 text-white py-12 px-4 w-full rounded-lg text-center" data-aos="fade-up">
    ...
    <a href="#" class="bg-white text-red-600 py-3 px-8 rounded-full font-semibold hover:bg-red-100 transition duration-300" data-aos="fade-up" data-aos-delay="100">Get in Touch</a>
</section>
