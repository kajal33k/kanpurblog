...
<head>
    ...
    <title>13 Best Places to Visit in Kanpur</title>
...
<!-- Main Content -->
    <main class="container mx-auto px-4 py-8 space-y-8">
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="https://via.placeholder.com/800x400" alt="Allen Forest Zoo" class="w-full h-48 object-cover">
            <div class="p-6">
        ...
        <!-- Place 2 -->
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="https://via.placeholder.com/800x400" alt="JK Temple" class="w-full h-48 object-cover">
            <div class="p-6">
        ...
        <!-- Place 3 -->
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="https://via.placeholder.com/800x400" alt="Kanpur Memorial Church" class="w-full h-48 object-cover">
            <div class="p-6">
        ...
        <!-- Place 4 -->
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="https://via.placeholder.com/800x400" alt="Moti Jheel" class="w-full h-48 object-cover">
            <div class="p-6">
        ...
        <!-- Place 5 -->
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="https://via.placeholder.com/800x400" alt="Nana Rao Park" class="w-full h-48 object-cover">
            <div class="p-6">
        ...
        <!-- Place 6 -->
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="https://via.placeholder.com/800x400" alt="ISKCON Temple" class="w-full h-48 object-cover">
            <div class="p-6">
        ...
        <!-- Place 7 -->
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="https://via.placeholder.com/800x400" alt="Phool Bagh" class="w-full h-48 object-cover">
            <div class="p-6">
        ...
        <!-- Place 8 -->
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="https://via.placeholder.com/800x400" alt="Kamla Retreat" class="w-full h-48 object-cover">
            <div class="p-6">
        ...
        <!-- Place 9 -->
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="https://via.placeholder.com/800x400" alt="Massacre Ghat" class="w-full h-48 object-cover">
            <div class="p-6">
        ...
        <!-- Place 10 -->
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="https://via.placeholder.com/800x400" alt="Blue World Theme Park" class="w-full h-48 object-cover">
            <div class="p-6">
        ...
        <!-- Place 11 -->
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="https://via.placeholder.com/800x400" alt="Bithoor" class="w-full h-48 object-cover">
            <div class="p-6">
        ...
        <!-- Place 12 -->
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="https://via.placeholder.com/800x400" alt="Green Park Stadium" class="w-full h-48 object-cover">
            <div class="p-6">
        ...
        <!-- Place 13 -->
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="https://via.placeholder.com/800x400" alt="Ganga Barrage" class="w-full h-48 object-cover">
            <div class="p-6">
    ...
    <footer class="bg-red-800 text-white py-6">
        <div class="container mx-auto px-4 text-center">
            <p>© 2024 Kanpur Tourism. All rights reserved.</p>
            <p>For more information, contact us at <a href="mailto:info@kanpurtourism.com" class="text-blue-400">info@kanpurtourism.com</a></p>
        </div>
    </footer>
