...
@section('content')
    ...
    <!-- Hero Section -->
    <section class="bg-red-700 text-white py-20" data-aos="fade-up">
        <div class="container mx-auto px-4">
            <h2 class="text-5xl font-bold mb-6" data-aos="fade-down" data-aos-delay="200">Exploring the Future of Technology</h2>
            <p class="text-xl mb-8" data-aos="fade-up" data-aos-delay="400">Discover the latest trends in Kanpur, global innovations, and the transformative power of AI</p>
            <a href="#" class="bg-white text-red-700 py-3 px-8 rounded-full font-semibold hover:bg-red-100 transition duration-300" data-aos="zoom-in" data-aos-delay="600">Learn More</a>
        </div>
    </section>
    ...
    <main class="container mx-auto px-4 py-12">
        ...
        <section class="mb-16" data-aos="fade-up">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white p-6 rounded-lg shadow-md" data-aos="flip-left">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md" data-aos="flip-right">
        ...
        <section class="mb-16" data-aos="fade-up">
            ...
            <div class="bg-white p-8 rounded-lg shadow-md" data-aos="zoom-in">
    ...
    <!-- Call to Action -->
    <section class="bg-red-600 text-white py-12 px-4 rounded-lg text-center" data-aos="fade-up">
        ...
        <a href="#" class="bg-white text-red-600 py-3 px-8 rounded-full font-semibold hover:bg-red-100 transition duration-300" data-aos="zoom-in">Contact Us Today</a>
    </section>
