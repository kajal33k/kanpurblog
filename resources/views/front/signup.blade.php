        ...
        <form>
            ...
            <div class="flex items-center mb-6">
                <label class="inline-flex items-center text-gray-700">
                    ...
                    <span class="ml-2">I agree to the <a href="#" class="text-red-500 hover:underline">Terms and Conditions</a></span>
                </label>
            </div>
            <button type="submit" class="w-full bg-red-500 text-white font-semibold py-2 rounded-lg shadow-md hover:bg-red-600 transition duration-200">Sign Up</button>
        </form>
        <p class="text-gray-700 text-center mt-6">Already have an account? <a href="#" class="text-red-500 hover:underline">Login</a></p>
    </div>
</div>
@endsection