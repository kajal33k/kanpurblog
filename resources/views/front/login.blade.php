...
<div class="flex justify-center m-8">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center" data-aos="fade-up">Login to Your Blog</h2>
        <form>
            <div class="mb-4">
            ...
            <div class="flex items-center justify-between mb-6">
                <label class="inline-flex items-center text-gray-700">
                    ...
                    <span class="ml-2" data-aos="fade-up">Remember me</span>
                </label>
                <a href="#" class="text-red-500 hover:underline" data-aos="fade-up">Forgot password?</a>
            </div>
            <button type="submit" class="w-full bg-red-500 text-white font-semibold py-2 rounded-lg shadow-md hover:bg-red-600 transition duration-200 " data-aos="fade-up">Login</button>
        </form>
        <p class="text-gray-700 text-center mt-6" data-aos="fade-up">Don't have an account? <a href="#" class="text-red-500 hover:underline" data-aos="fade-up">Sign Up</a></p>
    </div>
</div>
@endsection