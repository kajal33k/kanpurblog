...
<aside class="w-full lg:w-1/4 bg-white rounded-lg shadow-lg p-8 lg:p-6 mx-0 lg:mx-0">
    ...
    <ul class="space-y-4">
        <li>
            <a href="{{Route('iit')}}" class="text-red-600 hover:underline font-medium">The Growth of IT Sector in Kanpur</a>
            <p class="text-sm text-gray-600">An in-depth look at how the IT sector is evolving in Kanpur.</p>
        </li>
        <li>
            <a href="{{Route('iit')}}" class="text-red-600 hover:underline font-medium">Top IT Startups to Watch in Kanpur</a>
            <p class="text-sm text-gray-600">Explore the promising IT startups making waves in the city.</p>
        </li>
        <li>
            <a href="{{Route('iit')}}" class="text-red-600 hover:underline font-medium">How IT Companies are Shaping Kanpur's Economy</a>
            <p class="text-sm text-gray-600">Understanding the impact of IT companies on the local economy.</p>
        </li>
        <li>
            <a href="{{Route('iit')}}" class="text-red-600 hover:underline font-medium">Upcoming Tech Events in Kanpur</a>
